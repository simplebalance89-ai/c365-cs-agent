...
def demo() -> DemoResponse:
    ...
    # Mock inbound email: a new prospect asking about ERP consulting
    ...
    return DemoResponse(
        ...
        message=(
            "Live demo running. Classification and responses generated by Claude AI "
            "in real-time using C365 knowledge base. Connect Zendesk + Graph credentials "
            "to activate full workflow automation."
        ),
    )
